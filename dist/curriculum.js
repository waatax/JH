...
u('math',9,1,'三角形的外心、內心與重心','外心是三邊中垂線交點，到三頂點等距，為外接圓圓心；內心是三內角平分線交點，到三邊等距，為內切圓圓心；重心是三中線交點，將中線分為 2:1，三條中線將三角形分成六個等面積小三角形。','直角三角形外心在斜邊中點，斜邊長 10 則外接圓半徑為 5。若等腰三角形底邊 8、高 6，重心到底邊距離為 6×(1/3)＝2。','外心不一定在三角形內部（鈍角三角形外心在外部）；重心到頂點的距離是到對邊中點距離的 2 倍，不是相反。','畫一個直角三角形，標出斜邊中點（外心），並驗證它到三個頂點的距離是否相等。',[
