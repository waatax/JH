// scripts/build-diagrams.mjs - Generates full diagrams.js with 50 specialized SVG diagrams + domain fallbacks
...
fs.writeFileSync(path.resolve('dist/diagrams.js'), content, 'utf8');
console.log('Successfully written dist/diagrams.js with 65 specialized diagrams!');
